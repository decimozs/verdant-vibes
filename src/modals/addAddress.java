...
public class addAddress extends JFrame {
	...
	private void updateAddBtnText() {
		addBtn.setText("[New Address Added] - Name: " + setFirstName + " " + setInitial + " " + setLastName + " "
				+ " Address: " + setStreetNumber + " " + setStreetAddress + " " + setCity + " " + setCountry + " "
				+ setPostalCode);
	}
	...
	private void newAddressAdded() {
		try {
			...
			updateStreetAddress = home.auth.capitalizeFirstLetter(streetnumber.getText()) + " "
					+ home.auth.capitalizeFirstLetter(streetaddress.getText());
