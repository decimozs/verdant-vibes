	...
	public JPanel createAddress(int row) {
	    ...
	    address.addMouseListener(new MouseAdapter() {
	        ...
	        public void mouseClicked(MouseEvent e) {
	            ...
	            home.checkout.addressChoice.setText("" + home.addressTable.table.getValueAt(row, 3) + " " + home.addressTable.table.getValueAt(row, 4) + " " + home.addressTable.table.getValueAt(row, 5));
	            home.cps.streetDetails.setText("" + home.addressTable.table.getValueAt(row, 3));
	            home.cps.cityCountry.setText(home.addressTable.table.getValueAt(row, 4) + " " + home.addressTable.table.getValueAt(row, 5));
	            System.out.println("Retrieved Data");
	            System.out.println("Name: " + home.addressTable.table.getValueAt(row, 0) + " " + home.addressTable.table.getValueAt(row, 1) + " " + home.addressTable.table.getValueAt(row, 2)); 
	            setVisible(false);
	        }
	    });
	    return address;
