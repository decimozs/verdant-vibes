...
public class Home extends JFrame {
	...
	private JLabel discoverMorePlants;
	private JLabel mostLoved;
	private JLabel popular;
	private JPanel mostLovedMenu;
	...
	public Home() {
		...
		hamburgerMenu.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				contentPane.setComponentZOrder(hamburgerMenuPane, 0);
			}
		});
		...
		lblNewLabel.setIcon(new ImageIcon(Home.class.getResource("/resources/maskBg.png")));
		...
		lblNewLabel_4.setIcon(new ImageIcon(Home.class.getResource("/resources/maskBg.png")));
		...
		lblNewLabel_9.setBounds(28, 0, 172, 41);
		climbersMenu.add(lblNewLabel_9);
		
		lblNewLabel_10 = new JLabel("");
		lblNewLabel_10.setIcon(new ImageIcon(Home.class.getResource("/resources/maskBg.png")));
		...
		lblNewLabel_12.setIcon(new ImageIcon(Home.class.getResource("/resources/maskBg.png")));
		...
		lblNewLabel_7.setIcon(new ImageIcon(Home.class.getResource("/resources/maskBg.png")));
		...
		mostLovedMenu.add(mlplants3);
				...
				lblNewLabel_1.setIcon(new ImageIcon(Home.class.getResource("/resources/bgPane.png")));
				lblNewLabel_1.setBounds(0, 0, 952, 232);
				mostLovedMenu.add(lblNewLabel_1);
				
				lblNewLabel_2 = new JLabel("");
				lblNewLabel_2.setBounds(0, 0, 952, 232);
				mostLovedMenu.add(lblNewLabel_2);
		...
		lblNewLabel_3.setIcon(new ImageIcon(Home.class.getResource("/resources/bgPane.png")));
		...
		searchItem.setBounds(934, 51, 180, 37);
		...
		explore.setPreferredSize(new Dimension(133, 41));
		explore.setMinimumSize(new Dimension(133, 41));
		explore.setMaximumSize(new Dimension(133, 41));
		...
		lblNewLabel_13.setIcon(new ImageIcon(Home.class.getResource("/resources/maskBg.png")));
		...
		search.setBounds(913, 51, 244, 37);
		...
		background.setIcon(new ImageIcon(Home.class.getResource("/resources/DashboardBg.png")));
		...
		hamburgerMenuPane = new JPanel();
		hamburgerMenuPane.setBounds(51, 51, 233, 258);
		hamburgerMenuPane.setVisible(false);
		contentPane.add(hamburgerMenuPane);
		hamburgerMenuPane.setLayout(null);
		...
		home.setFont(new Font("Montserrat", Font.PLAIN, 30));
		home.setHorizontalAlignment(SwingConstants.LEFT);
		home.setBounds(27, 33, 124, 29);
		hamburgerMenuPane.add(home);
		
		account = new JLabel("Account");
		account.setHorizontalAlignment(SwingConstants.LEFT);
		account.setFont(new Font("Montserrat", Font.PLAIN, 30));
		account.setBounds(27, 77, 167, 29);
		hamburgerMenuPane.add(account);
		...
		logOut.setFont(new Font("Montserrat", Font.PLAIN, 30));
		logOut.setBounds(27, 190, 167, 45);
		hamburgerMenuPane.add(logOut);
